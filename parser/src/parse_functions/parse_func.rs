...
use crate::{ParseResult, Parser, parse_functions::{parse_block::parse_block_stmt, parse_ident::parse_ident, parse_type_hint::parse_type_hint}};
...
pub fn parse_func(parser: &mut Parser) -> ParseResult<Expression> {
    ...
    Ok(Expression::Function { token, name, params, block, ret_ty: ret_type })
}